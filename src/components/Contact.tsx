    ...
    <div>
      ...
      <div className="isolate bg-white py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-2xl sm:text-center text-left">
          <h2 className="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Fragen?<br/> Kontaktieren Sie uns!</h2>
          <p className="mt-2 text-lg/8 text-gray-600">Wir helfen Ihnen gerne weiter. Füllen Sie das Formular aus und wir melden uns bei Ihnen.</p>
        </div>
